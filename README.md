...
<head>
    ...
    <title>Alpha Battle - The Ultimate Gaming Experience</title>
    ...
    <style>
        ...
        body {
            ...
            margin: 0; padding: 0; background-color: var(--dark-bg); color: var(--text-color); overflow-x: hidden;
        }
        
        /* Pre-loader */
        #preloader {
            background: var(--dark-bg) url('https://i.gifer.com/ZZ5H.gif') no-repeat center center;
            background-size: 10%;
            height: 100vh; width: 100%; position: fixed; z-index: 10000;
        }
        ...
        .navbar {
            ...
            box-shadow: 0 2px 5px rgba(0,0,0,0.2); position: fixed; width: 100%; top: 0; z-index: 1000;
        }
        .navbar .container { display: flex; justify-content: space-between; align-items: center; height: 70px; }
        .navbar .logo { font-family: var(--font-family); font-size: 1.8em; font-weight: 700; color: var(--primary-color); text-shadow: 0 0 10px var(--primary-color); }
        .navbar ul { list-style: none; margin: 0; padding: 0; display: flex; }
        .navbar ul li a { padding: 15px 20px; text-decoration: none; color: var(--text-color); font-weight: 600; transition: color 0.3s, text-shadow 0.3s; }
        .navbar ul li a:hover { color: var(--primary-color); text-shadow: 0 0 5px var(--primary-color); }
        
        /* Hero Section */
        #hero {
            background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.8)), url('https://via.placeholder.com/1920x1080.png/0d0d0d?text=YOUR+GAME+BACKGROUND');
            background-size: cover; background-position: center; text-align: center; padding: 200px 20px 150px;
        }
        #hero h1 { font-family: var(--font-family); font-size: 4em; font-weight: 900; margin: 0 0 10px; text-transform: uppercase; color: #fff; text-shadow: 0 0 20px var(--primary-color); }
        #hero p { font-size: 1.3em; margin-bottom: 40px; max-width: 600px; margin-left: auto; margin-right: auto; }
        .download-button { font-family: var(--font-family); display: inline-block; background: linear-gradient(45deg, var(--secondary-color), var(--primary-color)); color: white; padding: 18px 40px; border-radius: 5px; text-decoration: none; font-weight: 700; font-size: 1.2em; transition: all 0.3s; border: 2px solid var(--primary-color); box-shadow: 0 0 20px rgba(255, 140, 0, 0.5); }
        .download-button:hover { transform: scale(1.05); box-shadow: 0 0 30px rgba(255, 140, 0, 0.8); }
